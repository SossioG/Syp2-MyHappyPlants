...
public class PlantDepricated implements Serializable {
     ...
     */
    public PlantDepricated(String plantId, String commonName, String scientificName, String familyName, String imageURL) {
    ...
    public PlantDepricated(String nickname, String plantId, Date lastWatered, long waterFrequency) {
        this.nickname = nickname;
        this.plantId = plantId;
        this.lastWatered = lastWatered;
        this.waterFrequency = waterFrequency;
    }
    public PlantDepricated(String nickname, String plantID, Date lastWatered) {
        this.nickname = nickname;
        this.plantId = plantID;
        this.lastWatered = lastWatered;
    }
     ...
     * @param imageURL image location.
     */
    public PlantDepricated(String nickname, String plantId, Date lastWatered, long waterFrequency, String imageURL) {
        this.nickname = nickname;
        this.plantId = plantId;
        this.lastWatered = lastWatered;
        this.waterFrequency = waterFrequency;
     ...
     * @param imageURL image location.
     */
    public PlantDepricated(String nickname, String plantId, Date lastWatered, String imageURL) {
        this.nickname = nickname;
        this.plantId = plantId;
        this.lastWatered = lastWatered;
        this.imageURL = imageURL;
